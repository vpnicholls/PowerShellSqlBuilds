...
if ($Databases)
{
    foreach ($Database in $Databases)
    {
        ...
        $OutputFileName = "H:\SQL-JOBLOGS\Full Backup $DatabaseName.log"
        ...
        $Job = New-Object -TypeName Microsoft.SqlServer.Management.SMO.Agent.Job -argumentlist $Instance.JobServer, "LiteSpeed Full Backup $DatabaseName"
...
"@
        ...
        $TimeSpan1 = New-TimeSpan -hours 23 -minutes $Minutes
